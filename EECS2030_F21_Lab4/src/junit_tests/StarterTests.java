...
public class StarterTests {
	...
	@Test
	public void test_development_01() {
		Channel ch1 = new Channel("Cafe Music BGM", 2, 100);
		Channel ch2 = new Channel("I Love You Venice", 2, 135);
		
		Subscriber f1 = new Subscriber("Alan", 2, 40);
		Monitor f2 = new Monitor("Stat Sensor A", 2);
		...
		ch1.releaseANewVideo("Jazz Piano Radio");
		f1.watch("Jazz Piano Radio", 30);

		assertEquals("Cafe Music BGM released <Jazz Piano Radio> and is followed by [Subscriber Alan, Monitor Stat Sensor A].", ch1.toString());
		assertEquals("I Love You Venice released no videos and is followed by [Subscriber Alan, Monitor Stat Sensor A].", ch2.toString());
		assertEquals("Subscriber Alan follows [Cafe Music BGM, I Love You Venice] and is recommended <Jazz Piano Radio>.", f1.toString());
		assertEquals("Monitor Stat Sensor A follows [I Love You Venice, Cafe Music BGM {#views: 1, max watch time: 30, avg watch time: 30.00}].", f2.toString());

		ch1.unfollow(f2);

		assertEquals("Monitor Stat Sensor A follows [I Love You Venice].", f2.toString());
		...
		ch2.releaseANewVideo("Video");

		assertEquals("Cafe Music BGM released <Jazz Piano Radio> and is followed by [Subscriber Alan, Monitor Stat Sensor A].", ch1.toString());
		assertEquals("I Love You Venice released <Video> and is followed by [Subscriber Alan, Monitor Stat Sensor A].", ch2.toString());
		assertEquals("Subscriber Alan follows [Cafe Music BGM, I Love You Venice] and is recommended <Jazz Piano Radio, Video>.", f1.toString());
		assertEquals("Monitor Stat Sensor A follows [I Love You Venice, Cafe Music BGM {#views: 1, max watch time: 30, avg watch time: 30.00}].", f2.toString());
		...
		assertEquals("I Love You Venice released <Video> and is followed by [Subscriber Alan, Monitor Stat Sensor A].", ch2.toString());
		assertEquals("Subscriber Alan follows [Cafe Music BGM, I Love You Venice] and is recommended <Jazz Piano Radio, Video>.", f1.toString());
		assertEquals("Monitor Stat Sensor A follows [I Love You Venice {#views: 1, max watch time: 40, avg watch time: 40.00}, Cafe Music BGM {#views: 1, max watch time: 30, avg watch time: 30.00}].", f2.toString());
		...
		assertEquals("I Love You Venice released <Video> and is followed by [Subscriber Alan, Monitor Stat Sensor A].", ch2.toString());
		assertEquals("Subscriber Alan follows [Cafe Music BGM, I Love You Venice] and is recommended <Jazz Piano Radio, Video>.", f1.toString());
		assertEquals("Monitor Stat Sensor A follows [I Love You Venice {#views: 2, max watch time: 40, avg watch time: 40.00}, Cafe Music BGM {#views: 1, max watch time: 30, avg watch time: 30.00}].", f2.toString());
	}
