...
public class StarterTests {
	...
	@Test
	public void test_cumulative_01() {

		Blueprint bp1 = new Blueprint(7);

		Floor f1 = new Floor(100);
		Floor f2 = new Floor(100);

		try {
			f1.addUnit("Room 1", 1, 1);
			f1.addUnit("Room 2", 1, 1);
			f1.addUnit("Room 3", 1, 1);
			f1.addUnit("Room 4", 1, 1);
			f1.addUnit("Room 5", 1, 1);
			f1.addUnit("Room 6", 19, 5);

			f2.addUnit("Room 1", 1, 1);
			f2.addUnit("Room 2", 1, 1);
			f2.addUnit("Room 3", 1, 1);
			f2.addUnit("Room 4", 1, 1);
			f2.addUnit("Room 5", 1, 1);
			f2.addUnit("Room 6", 19, 5);
		} catch(InsufficientFloorSpaceException e) {
			fail("Unexpected exception thrown");
		}

		try {
			f1.addUnit("Room 7", 1, 1);
			fail("Expected exception not thrown");
		} catch(InsufficientFloorSpaceException e) {
		...
		assertEquals(bp1.getFloors()[0], f1);
		assertEquals(bp1.getFloors()[1], f2);

		assertNotSame(bp1.getFloors()[0], f1);
		assertNotSame(bp1.getFloors()[1], f2);

		assertEquals(bp1.getFloors()[0].getUnits()[0], new Unit ("Room 1", 1, 1));
		assertEquals(bp1.getFloors()[0].getUnits()[1], new Unit ("Room 2", 1, 1));
		assertEquals(bp1.getFloors()[0].getUnits()[2], new Unit ("Room 3", 1, 1));
		assertEquals(bp1.getFloors()[0].getUnits()[3], new Unit ("Room 4", 1, 1));
		assertEquals(bp1.getFloors()[0].getUnits()[4], new Unit ("Room 5", 1, 1));
		assertEquals(bp1.getFloors()[0].getUnits()[5], new Unit ("Room 6", 5, 19));

		assertNotSame(bp1.getFloors()[0].getUnits()[0], new Unit ("Room 1", 1, 1));
		assertNotSame(bp1.getFloors()[0].getUnits()[1], new Unit ("Room 2", 1, 1));
		assertNotSame(bp1.getFloors()[0].getUnits()[2], new Unit ("Room 3", 1, 1));
		assertNotSame(bp1.getFloors()[0].getUnits()[3], new Unit ("Room 4", 1, 1));
		assertNotSame(bp1.getFloors()[0].getUnits()[4], new Unit ("Room 5", 1, 1));
		assertNotSame(bp1.getFloors()[0].getUnits()[5], new Unit ("Room 6", 5, 19));

		assertEquals(bp1.getFloors()[1].getUnits()[0], new Unit ("Room 1", 1, 1));
		assertEquals(bp1.getFloors()[1].getUnits()[1], new Unit ("Room 2", 1, 1));
		assertEquals(bp1.getFloors()[1].getUnits()[2], new Unit ("Room 3", 1, 1));
		assertEquals(bp1.getFloors()[1].getUnits()[3], new Unit ("Room 4", 1, 1));
		assertEquals(bp1.getFloors()[1].getUnits()[4], new Unit ("Room 5", 1, 1));
		assertEquals(bp1.getFloors()[1].getUnits()[5], new Unit ("Room 6", 5, 19));

		assertNotSame(bp1.getFloors()[1].getUnits()[0], new Unit ("Room 1", 1, 1));
		assertNotSame(bp1.getFloors()[1].getUnits()[1], new Unit ("Room 2", 1, 1));
		assertNotSame(bp1.getFloors()[1].getUnits()[2], new Unit ("Room 3", 1, 1));
		assertNotSame(bp1.getFloors()[1].getUnits()[3], new Unit ("Room 4", 1, 1));
		assertNotSame(bp1.getFloors()[1].getUnits()[4], new Unit ("Room 5", 1, 1));
		assertNotSame(bp1.getFloors()[1].getUnits()[5], new Unit ("Room 6", 5, 19));

		assertEquals(bp1.getFloors()[0].getUnits()[0], bp1.getFloors()[1].getUnits()[0]);
		assertEquals(bp1.getFloors()[0].getUnits()[1], bp1.getFloors()[1].getUnits()[1]);
		assertEquals(bp1.getFloors()[0].getUnits()[2], bp1.getFloors()[1].getUnits()[2]);
		assertEquals(bp1.getFloors()[0].getUnits()[3], bp1.getFloors()[1].getUnits()[3]);
		assertEquals(bp1.getFloors()[0].getUnits()[4], bp1.getFloors()[1].getUnits()[4]);
		assertEquals(bp1.getFloors()[0].getUnits()[5], bp1.getFloors()[1].getUnits()[5]);

		assertNotSame(bp1.getFloors()[0].getUnits()[0], bp1.getFloors()[1].getUnits()[0]);
		assertNotSame(bp1.getFloors()[0].getUnits()[1], bp1.getFloors()[1].getUnits()[1]);
		assertNotSame(bp1.getFloors()[0].getUnits()[2], bp1.getFloors()[1].getUnits()[2]);
		assertNotSame(bp1.getFloors()[0].getUnits()[3], bp1.getFloors()[1].getUnits()[3]);
		assertNotSame(bp1.getFloors()[0].getUnits()[4], bp1.getFloors()[1].getUnits()[4]);
		assertNotSame(bp1.getFloors()[0].getUnits()[5], bp1.getFloors()[1].getUnits()[5]);

		assertEquals("28.6 percents of building blueprint completed (2 out of 7 floors)", bp1.toString());

		bp1.addFloorPlan(new Floor(f1));
		bp1.addFloorPlan(new Floor(f1));
		bp1.addFloorPlan(new Floor(f1));
		bp1.addFloorPlan(new Floor(f1));
		bp1.addFloorPlan(new Floor(f1));

		assertEquals("100.0 percents of building blueprint completed (7 out of 7 floors)", bp1.toString());
