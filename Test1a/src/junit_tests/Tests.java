 ...
 * 	 
 *   Then HeeYeons completion rate so far is 15% + 20% = 35% (i.e., 0.35), 
...
public class Tests {
	...
	@Test
	public void test_cumulative_system() {
		StudentRecord studentRecord = new StudentRecord("EECS2030");

		Assessment assessment1 = new Assessment("Assessment 1", 0.1, 100);
		Assessment assessment2 = new Assessment("Assessment 2", 0.1, 100);
		Assessment assessment3 = new Assessment("Assessment 3", 0.1, 100);
		Assessment assessment4 = new Assessment("Assessment 4", 0.1, 100);
		Assessment assessment5 = new Assessment("Assessment 5", 0.1, 100);

		studentRecord.addAssessment(assessment1);
		studentRecord.addAssessment(assessment2);
		studentRecord.addAssessment(assessment3);
		studentRecord.addAssessment(assessment4);
		studentRecord.addAssessment(assessment5);

		studentRecord.addAssessment("Assessment 6", 0.1, 100);
		studentRecord.addAssessment("Assessment 7", 0.1, 100);
		studentRecord.addAssessment("Assessment 8", 0.1, 100);
		studentRecord.addAssessment("Assessment 9", 0.1, 100);
		studentRecord.addAssessment("Assessment 10", 0.1, 100);

		assertEquals("Number of assessments in EECS2030: 10 ["
			+ "Assessment 1 (weight: 10.000 percents; marks: 100), "
			+ "Assessment 2 (weight: 10.000 percents; marks: 100), "
			+ "Assessment 3 (weight: 10.000 percents; marks: 100), "
			+ "Assessment 4 (weight: 10.000 percents; marks: 100), "
			+ "Assessment 5 (weight: 10.000 percents; marks: 100), "
			+ "Assessment 6 (weight: 10.000 percents; marks: 100), "
			+ "Assessment 7 (weight: 10.000 percents; marks: 100), "
			+ "Assessment 8 (weight: 10.000 percents; marks: 100), "
			+ "Assessment 9 (weight: 10.000 percents; marks: 100), "
			+ "Assessment 10 (weight: 10.000 percents; marks: 100)]",
			studentRecord.getAssessmentReport()
		);

		studentRecord.removeAssessment("Assessment 10");

		assertEquals(
			"Number of assessments in EECS2030: 9 ["
			+ "Assessment 1 (weight: 10.000 percents; marks: 100), "
			+ "Assessment 2 (weight: 10.000 percents; marks: 100), "
			+ "Assessment 3 (weight: 10.000 percents; marks: 100), "
			+ "Assessment 4 (weight: 10.000 percents; marks: 100), "
		...
		assertEquals(1.0, studentRecord.getCompletionRate(), 0.01);
		assertEquals(100.0, studentRecord.getRawMarks(), 0.01);
	}
