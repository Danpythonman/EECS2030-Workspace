...
public class Tests {
	...
	@Test
	public void test_development_01a() {
		Account a = new Account("Joe", 100);

		try {
			assertEquals("A regular account owned by Joe with balance $100", a.toString());
			a.switchToRegular();
			fail();
		}
		catch(InvalidStatusToSwitchException e) {
		...
		try {
			a.switchToVIP(25);
			assertEquals("A VIP account owned by Joe with balance $75 ($25 deposited for maintaining the VIP stauts)", a.toString());
		}
		catch(InvalidStatusToSwitchException e) {
			fail();
		}
	...
	@Test
	public void test_development_01b() {
		Bank b1 = new Bank();
		...
		assertSame(b1.getReferencesOfAccounts()[0], b2.getReferencesOfAccounts()[0]);
		assertSame(b1.getReferencesOfAccounts()[1], b2.getReferencesOfAccounts()[1]);
		assertEquals(b1.getReferencesOfAccounts()[0], b2.getReferencesOfAccounts()[0]);
		assertEquals(b1.getReferencesOfAccounts()[1], b2.getReferencesOfAccounts()[1]);

		assertSame(b1.getReferencesOfAccounts()[0], a1);
		assertSame(b1.getReferencesOfAccounts()[1], a2);
		assertEquals(b1.getReferencesOfAccounts()[0], a1);
		assertEquals(b1.getReferencesOfAccounts()[1], a2);

		assertSame(b2.getReferencesOfAccounts()[0], a1);
		assertSame(b2.getReferencesOfAccounts()[1], a2);
		assertEquals(b2.getReferencesOfAccounts()[0], a1);
		assertEquals(b2.getReferencesOfAccounts()[1], a2);
		...
		assertNotSame(a1, null);
		assertNotEquals(a1, null);
		assertNotSame(a2, null);
